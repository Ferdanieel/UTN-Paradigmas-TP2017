...
pelearAmigos unProtagonista unosProtagonistas = nuevosAmigos (amigos unProtagonista \\ unosProtagonistas) unProtagonista
...
comerSemillasDeHermitanio semillas unZombie unProtagonista | vida unProtagonista <= 0 = unProtagonista
                                                           | vida unProtagonista > 0 && semillas <= 10 = nuevaVida (vida unProtagonista * 0 + 100) unProtagonista
...
muerte unProtagonista = nuevaVida (vida unProtagonista * 0) (nuevosAmigos (amigos unProtagonista \\ [krilin,victorSueiro]) unProtagonista)

{- Consultas:
1) pelear maggie [daryl,carol,victorSueiro]
Protagonista {nombre = "maggie", vida = 100, reaccion = <function>, amigos = [Protagonista {nombre = "krilin", vida = 1, reaccion = <function>, amigos = []}]}

2) zombieBuenazoAstuto maggie 5
Protagonista {nombre = "maggie", vida = 25, reaccion = <function>, amigos = [Protagonista {nombre = "carol", vida = 200, reaccion = <function>, amigos = [Protagonista {nombre = "victorSueiro", vida = 1, reaccion = <function>, amigos = []}]},Protagonista {nombre = "daryl", vida = 55, reaccion = <function>, amigos = [Protagonista {nombre = "carol", vida = 200, reaccion = <function>, amigos = [Protagonista {nombre = "victorSueiro", vida = 1, reaccion = <function>, amigos = []}]}]},Protagonista {nombre = "krilin", vida = 1, reaccion = <function>, amigos = []}]}

3) zombieBuenazoAstuto maggie 2
Protagonista {nombre = "maggie", vida = 80, reaccion = <function>, amigos = [Protagonista {nombre = "carol", vida = 200, reaccion = <function>, amigos = [Protagonista {nombre = "victorSueiro", vida = 1, reaccion = <function>, amigos = []}]},Protagonista {nombre = "daryl", vida = 55, reaccion = <function>, amigos = [Protagonista {nombre = "carol", vida = 200, reaccion = <function>, amigos = [Protagonista {nombre = "victorSueiro", vida = 1, reaccion = <function>, amigos = []}]}]},Protagonista {nombre = "krilin", vida = 1, reaccion = <function>, amigos = []}]}
